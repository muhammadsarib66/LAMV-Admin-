...
const MainCategory = () => {
    ...
    console.log(item)
     const data = TableData.filter((i)=> i !== item)
     setTableData(data)   
    }
  ...
  return (
    ...
    <CardHeader floated={false} shadow={false} className="rounded-none">
        <div className="mb-8 flex items-center justify-between gap-8">
          ...
          <div  className="flex shrink-0 flex-col gap-2 sm:flex-row">
            ...
            <Button onClick={()=>dispatch(setisMainCatModal())}  className="flex items-center gap-3" size="sm">
            ...
            {TableData.map((item, index) => {
              ...
              return (
                <tr key={index}>
                  ...
                  <td onClick={()=>HandleDelete(item)} className={classes}>
   ...
   <AddMainCategoryModal  AddCat={AddCat}/>
   </>
  )
}
